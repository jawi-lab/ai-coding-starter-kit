    ...
    <div className="space-y-3">
      ...
      {loading ? (
        <div className="space-y-2">
          {[1, 2].map(i => (
            <Skeleton key={i} className="h-10 w-full rounded-sm bg-surface" />
          ))}
        </div>
        ...
        <div className="space-y-2">
          {blocks.map(block => (
            <div
              key={block.id}
              className="flex items-center gap-2 bg-surface border border-line rounded-sm px-3 py-2.5"
            >
      ...
      {showForm ? (
        <div className="bg-surface border border-line rounded-md p-3.5 space-y-2.5">
          <div className="space-y-1.5">
            <label className="text-[11.5px] font-[700] text-ink-2 tracking-[0.06em]">
              Von *
            </label>
            <Input
              ref={startInputRef}
